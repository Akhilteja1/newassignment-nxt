...
const doctors=[ {
    id: 1,
        name: 'Dr. Sachin',
        maxPatients: 10,
        schedule: ['Monday', 'Wednesday', 'Friday'], //  schedule
}
...
,
    ...
    id: 2,
        name: 'Dr. Dhoni',
        maxPatients: 12,
        schedule: ['Tuesday', 'Thursday'], //  schedule
},
{
    id: 3,
        name: 'Dr. Virat',
...
app.post('/appointments', (req, res)=> {
        ...
        if (dayOfWeek===0) {
            return res.status(400).json( {
                    message: 'Doctors do not work on Sundays'
                }
        ...
        if (doctor.schedule.includes(currentDay)) {
            ...
            if (doctorAppointments.length < doctor.maxPatients) {
                ...
                return res.status(400).json( {
                        message: 'Doctor is fully booked for the day'
                    }
